...
% We first show that our protocol provides a total order of operations. To provide \mdl, we must guarantee a total order that also respects per client invocation order. We show this 

% To provide linearizability, we must alos show our protocol respects real time orderings.

% Lastly, we show that our protocol respects our defined failure semantics.
