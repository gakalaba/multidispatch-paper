...
\begin{algorithm}[!tb]
    ...
    \Function{\Recover(\textit{E})}{
        ...
        \For{$\mathrm{each}$ $ e \in E$}{
            \If{$e.\mathrm{pred} = null \lor S_e = S_{e.\mathrm{pred}}$}{
                \label{neginfy}
                $e.\mathrm{pred\_ts} \gets -\infty$\\
            }
        ...
        $A\sorting(\text{by} \enspace pred\_ts)$\\
        $q \gets \constructQueue()$\\
        \For{$e \in A$}{
