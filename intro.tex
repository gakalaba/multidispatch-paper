...
We present \sys{}, the first protocol for providing cross-shard \mdl{}.
...
\item An implementation and evaluation of \sys{} that shows \true{approaches half latency for application requests compared to a Linearizable baseline as fanout increases.}
\end{itemize}
