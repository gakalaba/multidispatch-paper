...
proof in Appendix~\ref{sec:equivalence} includes them.)
...
\noindentparagraph{\Multidispatch{} Linearizability.} An execution $\alpha_1$ satisfies \textit{\multidispatch{} linearizability} if it
...
equivalence. (A complete proof is elided here for brevity but can be found in Appendix~\ref{sec:equivalence}.) For ease of exposition, we focus on the actions within an
