...
Somewhat counter-intuitively, three shards outperforms nine shards. Similar to
the single-shard case, with fewer shards there is the average leader-leader
...
The nine-shard configuration approaches the lower bound improvement over \mpaxos
described in~\ref{sec:design} for fanouts $100$ and $1000$, with p99 latency
close to 25\% of \mpaxos.  An application-level request of fanout $n$ induces
$n-1$ 1-way intershard coordination messages, that must be serialized with
