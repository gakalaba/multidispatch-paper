...
\def\mdllong  {Invocation-Order Concurrent Linearizability\xspace}
\def\mdl{IOC Linearizability\xspace}
\def\Mdl{IOC Linearizability\xspace}
\def\iocll{IOC Linearizable\xspace}
\def\IOCL{IOCL\xspace}
% \def\sd{single-dispatch Linearizability\xspace}
\def\md{IOC Linearizability\xspace}
\def\protocol {Ellis\xspace}
\def\system {Ellis\xspace}

\newcommand*{\sys}{Ellis}
% \newcommand*{\SDL}{single-dispatch Linearizability}
\newcommand*{\MDL}{IOC Linearizability}
\newcommand*{\singledispatch}{single-dispatch}
\newcommand*{\Singledispatch}{Single-dispatch}
\newcommand*{\multidispatch}{invocation-order concurrent}
\newcommand*{\Multidispatch}{Invocation-Order Concurrent}
